...
//        canvas.drawRect(0,250,500,750,paint); //矩形


//        RadialGradient radialGradient = new RadialGradient(250, 250, 250, new int[]{Color.RED, Color.BLUE, Color.GREEN}, null, Shader.TileMode.CLAMP);
